        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    eloLOL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    champ = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    laneMain = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    laneSecundaria = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
